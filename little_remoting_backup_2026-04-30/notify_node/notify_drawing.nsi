...
InstallDirRegKey HKLM "Software\ca2\app-core\notify_drawing" "Install_Dir"
...
Section "BeatMapper (required)"
  ...
  ; Set output path to the installation directory.
  SetOutPath "$INSTDIR\app-core\appmatter\notify_drawing"
  
  ; Put file there
  File /r "C:\ca2\app-core\appmatter\notify_drawing\"
  ...
  File "C:\ca2\time\x64\stage\notify_drawing_notify_drawing.dll"
  File "C:\ca2\time\x64\stage\notify_drawing_notify_drawing.exe"
  
  
  ExecWait '"$INSTDIR\time\x64\stage\notify_drawing_notify_drawing.exe" : install' $0
  
  ; Write the installation path into the registry
  WriteRegStr HKLM "SOFTWARE\ca2\app-core\notify_drawing" "Install_Dir" "$INSTDIR"
  
  ; Write the uninstall keys for Windows
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\notify_drawing_notify_drawing" "DisplayName" "Beat Mapper!!"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\notify_drawing_notify_drawing" "UninstallString" '"$INSTDIR\uninstall.exe"'
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\notify_drawing_notify_drawing" "NoModify" 1
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\notify_drawing_notify_drawing" "NoRepair" 1
...
Section "Start Menu Shortcuts"
  ...
  CreateShortcut "$SMPROGRAMS\Beat Mapper!!\Beat Mapper!!.lnk" "$INSTDIR\time\x64\stage\notify_drawing_notify_drawing.exe" "" "$INSTDIR\time\x64\stage\notify_drawing_notify_drawing.exe" 0
...
Section "Uninstall"
  ...
  DeleteRegKey HKLM "SOFTWARE\ca2\app-core\notify_drawing"

  ; Remove files and uninstaller
  Delete "$INSTDIR\notify_drawing_notify_drawing.nsi"
