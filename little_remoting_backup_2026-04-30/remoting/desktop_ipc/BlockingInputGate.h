...
namespace remoting
{
   ...
   class CLASS_DECL_REMOTING  BlockingInputGate :
   ...
   public:
      ...
      BlockingInputGate();
      BlockingInputGate(InputStream *pinputstream);
      ~BlockingInputGate() override;


      virtual void _initialize_blocking_input_gate(InputStream *pinputstream);
