...
namespace remoting_node
{
   ...
   public:
       ...
       */
      static bool validateUINT(::innate_subsystem::TextBox *textBox, const ::scoped_string & scopedstrMessageText);
      /**
       ...
       */
      static void notifyValidationError(::innate_subsystem::TextBox *textBox, const ::scoped_string & scopedstrMessageText);
   private:
      /**
