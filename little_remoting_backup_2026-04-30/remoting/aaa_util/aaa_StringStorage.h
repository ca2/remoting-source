...
//    * another ::string object. endIndex is included, so the maximum length
...
//   void getSubstring(::string & substr, size_t startIndex,
...
//    */
//   bool isEqualTo(const ::scoped_string & scopedstrother) const;
//
//   /**
...
//   //
//
//   bool split(const ::scoped_string & scopedstrDelimiters, ::string & stringArray, size_t *arrayLength) const;
//
//   //
