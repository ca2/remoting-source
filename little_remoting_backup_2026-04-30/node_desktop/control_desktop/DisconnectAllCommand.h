...
{
   /**
    * Command that invokes remote disconnectAll() method of Remoting Node
    * using control transport.
    */
   class DisconnectAllCommand : public ::subsystem::Command
   {
   public:
      /**
       * Creates command.
       ...
       */
      DisconnectAllCommand(ControlProxy * pcontrolproxy);
      /**
       * Destroys command.
       */
