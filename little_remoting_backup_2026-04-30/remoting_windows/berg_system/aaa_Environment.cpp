...
// }
//
// bool Environment::getCurrentUserName(::string & out, ::subsystem::LogWriter * plogwriter)
// {
//   *out = WindowsSubsystem().WTS().getCurrentUserName(plogwriter);
//   return !out->is_empty();
// }
//
...
// }
//
// bool Environment::isAeroOn(::subsystem::LogWriter * plogwriter)
// {
//   try {
