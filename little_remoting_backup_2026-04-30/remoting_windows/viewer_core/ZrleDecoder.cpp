...
namespace remoting
{
                            ...
                            const ::i32_rectangle &  rectangleTarget)
   {
      ...
      ::ByteArrayInputStream unpackedByteArrayStream(reinterpret_cast<char_pointer >(unpackedData.data()),
                                                   unpackedData.size());
      ...
      if (pixelformat.bitsPerPixel == 8) {
         ...
         ::u32 colorMaxValue =  pixelformat.blueMax  << pixelformat.blueShift  |
