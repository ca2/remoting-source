...
jpeg_idct_7x7 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  int tmp0, tmp1, tmp2, tmp10, tmp11, tmp12, tmp13;
  int z1, z2, z3;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
...
jpeg_idct_6x6 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  int tmp0, tmp1, tmp2, tmp10, tmp11, tmp12;
  int z1, z2, z3;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
...
jpeg_idct_5x5 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  int tmp0, tmp1, tmp10, tmp11, tmp12;
  int z1, z2, z3;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
...
jpeg_idct_9x9 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  int tmp0, tmp1, tmp2, tmp3, tmp10, tmp11, tmp12, tmp13, tmp14;
  int z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
...
jpeg_idct_10x10 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  int tmp10, tmp11, tmp12, tmp13, tmp14;
  int tmp20, tmp21, tmp22, tmp23, tmp24;
  int z1, z2, z3, z4, z5;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
...
{
  int tmp10, tmp11, tmp12, tmp13, tmp14;
  int tmp20, tmp21, tmp22, tmp23, tmp24, tmp25;
  int z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
...
{
  int tmp10, tmp11, tmp12, tmp13, tmp14, tmp15;
  int tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26;
  int z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
...
jpeg_idct_14x14 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  int tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16;
  int tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26;
  int z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[4*2];	/* buffers data between passes */
  SHIFT_TEMPS
  ...
  for (ctr = 0; ctr < 2; ctr++) {
    ...
    /* Add range center and fudge factor for final descale and range-limit. */
    tmp0 = wsptr[0] + ((((int) RANGE_CENTER) << 3) + (ONE << 2));
    tmp2 = wsptr[2];
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[2*4];	/* buffers data between passes */
  SHIFT_TEMPS
