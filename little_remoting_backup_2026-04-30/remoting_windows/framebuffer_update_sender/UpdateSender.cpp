...
UpdateSender::UpdateSender() :
   ...
   void UpdateSender::addUpdateContainer(const UpdateContainer & updatecontainer)
   {
      ...
      updatecontainer.m_regionVideo-= rectangleViewport.top_left();
      updatecontainer.m_regionChanged-= rectangleViewport.top_left();
      updatecontainer.m_regionCopied-= rectangleViewport.top_left();
      updatecontainer.m_pointCopySource -= rectangleViewport.top_left();

      m_pupdatekeeper->addUpdateContainer(&updatecontainer);
   }
