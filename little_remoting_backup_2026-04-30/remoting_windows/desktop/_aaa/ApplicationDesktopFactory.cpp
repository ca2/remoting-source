...
namespace remoting_windows
{
   ...
   ::pointer < Desktop > ApplicationDesktopFactory::createDesktop(::subsystem::ClipboardListener *pclipboardlistenerExternal,
                                                     ...
                                                     ::subsystem::LogWriter * plogwriter)
   {
      ...
      pdesktopwinimpl->initialize_desktop_win_impl(pclipboardlistenerExternal, pupdatesendinglistenerExternal, pdesktermlistenerExternal, plogwriter);
