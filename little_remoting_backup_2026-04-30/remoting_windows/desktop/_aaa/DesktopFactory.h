...
namespace remoting_windows
{
   ...
   public:
      ...
      virtual ::pointer < Desktop > createDesktop(::subsystem::ClipboardListener *pclipboardlistenerExternal,
                                     UpdateSendingListener *pupdatesendinglistenerExternal,
                                     AbnormDeskTermListener *pdesktermlistenerExternal, ::subsystem::LogWriter * plogwriter) = 0;
   };
