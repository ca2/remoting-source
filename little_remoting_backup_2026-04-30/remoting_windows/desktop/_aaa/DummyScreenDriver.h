...
namespace remoting_windows
{
   ...
   {
   public:
      //DummyScreenDriver(::remoting::UpdateKeeper * pupdatekeeper, ::remoting::UpdateListener * pupdatelistener, const ::i32_size & size,
        //                unsigned int interval, ::subsystem::LogWriter * plogwriter);

      DummyScreenDriver();
      virtual ~DummyScreenDriver();

      virtual void initialize_dummy_screen_driver(::remoting::UpdateKeeper * pupdatekeeper, ::remoting::UpdateListener * pupdatelistener, const ::i32_size & size,
                        unsigned int interval, ::subsystem::LogWriter * plogwriter);
